...
class ChopEvent : Event(Random.nextInt(1920, 2460)) { //1920s = 32 minutes
    ...
    private fun type() {
        ...
        OCRHandler.getOCRHandler().log(this.javaClass.name, "Attempting to chop ${Constants.logs}")
        //Copy below string to clipboard
        WinHook.copy("/chop log:${Constants.logs}")
