...
class BuryEvent : Event(Random.nextInt(1920, 2460)) { //1920s = 32 minutes
    ...
    private fun type() {
        ...
        OCRHandler.getOCRHandler().log(this.javaClass.name, "Attempting to bury ${Constants.bones}")
        //Copy below string to clipboard
        WinHook.copy("/bury name:${Constants.bones}")
